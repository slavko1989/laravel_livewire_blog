        ...
        <table class="min-w-full text-left text-sm font-light">
          <thead class="border-b font-medium">
            <tr>
              ...
              <th scope="col" class="px-6 py-4">Sub Cat</th>
          ...
          <tbody>
            ...
            <tr class="border-b">
              ...
              <td class="whitespace-nowrap px-6 py-4 font-medium">{{ $category->created_at->format('m/d/y') }}</td>
              <td class="whitespace-nowrap px-6 py-4 font-medium">{{ $category->updated_at->format('m/d/y') }}</td>
              <td class="whitespace-nowrap px-6 py-4 font-medium">
                <a href="{{ route('categories.edit',$category) }}"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
